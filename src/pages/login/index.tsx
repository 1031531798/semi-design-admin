...
const Login = () => {
    ...
    function renderForm () {
        ...
        const loginAnimate = isLogin ? 'animate__fadeInRight' : 'animate__fadeOutRight'
        const registerAnimate = !isLogin ? 'animate__fadeInLeft' : 'animate__fadeOutLeft'
        const loginForm = (
            <div className={`flex flex-row align-midden justify-center animate__animated ` + loginAnimate} style={{flex: 1}}>
                <LoginForm setFormActive={setFormActive} />
            </div>
        )
        const registerForm = (
            <div className={`absolute w-full flex flex-row align-midden justify-center animate__animated ` + registerAnimate} style={{flex: 1, top: 0, display: firstShow ? 'none' : 'flex'}}>
        ...
        <div className={prefixCls}>
            ...
            <div className={`${prefixCls}-main flex flex-col`}>
                ...
                <div className={`${prefixCls}-main-body flex flex-row justify-center`}>
                    <div className={`${prefixCls}-main-body-img flex-row justify-center items-center hidden xl:flex`}>
