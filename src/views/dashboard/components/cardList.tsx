...
export const HomeCardList = () => {
    const cards = [
        ...
        {icon: <GiReceiveMoney size={30} color={'#1fcb4f'} />, title: '收益', value: '3522'},
        {icon: <GiPayMoney size={30} color={'#1fcb4f'} />, title: '费用', value: '5819'},
        {icon: <GiTakeMyMoney size={30} color={'#1fcb4f'} />, title: '存款', value: '30020'},
    ]
    return (
        <>
